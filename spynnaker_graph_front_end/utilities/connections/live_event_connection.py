"""
LiveSpikesConnection
"""

# graph front end imports
from spynnaker_graph_front_end.utilities.connections.database_connection \
    import DatabaseConnection
from spynnaker_graph_front_end.utilities.connections.sender_connection \
    import SenderConnection
...
class LiveEventConnection(DatabaseConnection):
    ...
    def add_start_callback(self, label, start_callback):
        ...
        :param label: the label for the callback
        :type label: str
        """
    ...
    def _read_database_callback(self, database_reader):
        ...
        if self._send_labels is not None:
            self._sender_connection = SenderConnection()
