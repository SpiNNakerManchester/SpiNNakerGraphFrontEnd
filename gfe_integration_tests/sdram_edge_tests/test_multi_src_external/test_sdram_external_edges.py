...
from gfe_integration_tests.sdram_edge_tests import test_multi_src_external
import spinnaker_graph_front_end as sim
from gfe_integration_tests.sdram_edge_tests. \
    test_multi_src_external.basic_sdram_splitter import BasicSDRAMSplitter
from gfe_integration_tests.sdram_edge_tests. \
    test_multi_src_external.sdram_splitter import SDRAM_Splitter


class TestMultiSrcSDRAMEdgeOverTwoAppVert(unittest.TestCase):

    def setup(self):
        sim.setup(model_binary_module=test_multi_src_external)
