...
if __name__ == '__main__':
    ...
    gfe_integration_tests_dir = os.path.dirname(tests_dir)
    gfe_dir = os.path.dirname(gfe_integration_tests_dir)

    spinnaker_graph_front_end_dir = os.path.join(
        gfe_dir, "spinnaker_graph_front_end")
    # Jenkins appears to place Introlabs here
    if not os.path.exists(spinnaker_graph_front_end_dir):
        parent_dir = os.path.dirname(gfe_dir)
        spinnaker_graph_front_end_dir = os.path.join(
            parent_dir, "spinnaker_graph_front_end")
    examples_dir = os.path.join(spinnaker_graph_front_end_dir, "examples")
