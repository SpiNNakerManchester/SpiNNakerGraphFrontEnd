...
static bool initialize() {
    log_info("Initialise mul: started\n");
    ...
    if (transmission_region_address[HAS_KEY] == 1) {
        ...
        log_info("Mul vertex without key, just perform the mul and record the result");
    }
