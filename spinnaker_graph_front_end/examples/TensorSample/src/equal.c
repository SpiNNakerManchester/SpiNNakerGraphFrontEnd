...
static bool initialize() {
    log_info("Initialise equal: started\n");
    ...
    if (transmission_region_address[HAS_KEY] == 1) {
        ...
        log_info("Equal vertex without key.");
    }
 ...
 */
void c_main() {
    log_info("starting equal operation\n");
