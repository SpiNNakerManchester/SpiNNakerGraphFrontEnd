...
def read_data_sets(data_dir, one_hot, reshape):
    ...
    train_dataset = load_dataset(train_images_file, train_labels_file) # 14 nodes
    train_dataset = train_dataset.shuffle(60000) # nodes 15-25
    test_dataset = load_dataset(test_images_file, test_labels_file) # 26 - 38 nodes
    mnist = Mnist(train_dataset, test_dataset, one_hot, reshape) # 39- 66 nodes
    return mnist
