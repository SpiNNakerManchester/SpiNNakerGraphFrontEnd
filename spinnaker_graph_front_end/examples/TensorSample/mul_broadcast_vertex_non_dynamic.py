...
class MulBroadcastND(MachineVertex,
    ...
    def resources_required(self):
        resources = ResourceContainer(sdram=ConstantSDRAM(
             ...
             self.SIZE_VAR + self.RANK_VAR + self.DIMENSION * self.rank1 +
             self.SIZE_VAR + self.RANK_VAR + self.DIMENSION * self.rank2 +
    ...
    def _reserve_memory_regions(self, spec):
        print("\n mul_broadcast_vertex _reserve_memory_regions")
        ...
        spec.reserve_memory_region(
            ...
            size=self.SIZE_VAR + self.RANK_VAR + self.DIMENSION * self.rank1, label="shape1")
        spec.reserve_memory_region(
            region=self.DATA_REGIONS.TENSOR2_PROPERTIES.value,
            size=self.SIZE_VAR + self.RANK_VAR + self.DIMENSION * self.rank2, label="shape2")
        spec.reserve_memory_region(
    ...
    def generate_machine_data_specification(
        ...
        print("\n mul_broadcast_vertex generate_machine_data_specification")
