...
class MulVertex(MachineVertex, AbstractHasAssociatedBinary,
    ...
    def _reserve_memory_regions(self, spec):
        print("\n mul_vertex _reserve_memory_regions")

        spec.reserve_memory_region(
            region=self.DATA_REGIONS.TRANSMISSIONS.value,
            size=self.TRANSMISSION_DATA_SIZE, label="keys")
        spec.reserve_memory_region(
            region=self.DATA_REGIONS.RECORDED_MUL_RESULT.value,
            size=self.RECORDING_DATA_SIZE, label="recorded_mul_result")
    ...
    def generate_machine_data_specification(
        ...
        print("\n mul_vertex generate_machine_data_specification")
    ...
    def read(self, placement, txrx):
        ...
        base_address_offset = get_region_base_address_offset(
            app_data_base_address, self.DATA_REGIONS.RECORDED_MUL_RESULT.value)
