...
class NegVertex(MachineVertex,
    ...
    def _reserve_memory_regions(self, spec):
        print("\n neg_vertex _reserve_memory_regions")
    ...
    def generate_machine_data_specification(self, spec, placement, machine_graph,
        ...
        print("\n neg_vertex generate_machine_data_specification")
