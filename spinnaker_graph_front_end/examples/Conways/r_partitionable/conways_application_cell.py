...
class ConwaysApplicationGrid(
    ...
    def _calculate_dtcm_usage(vertex_slice):
        return (112 +  # static params
                (4 * 2 * vertex_slice.n_atoms) +  # input buffer
                (4 * vertex_slice.n_atoms) +  # initial states
                (4 * vertex_slice.n_atoms) +  # alive states
                (4 * vertex_slice.n_atoms) +  # dead states
                (4 * vertex_slice.n_atoms) +  # alive states copy
                (4 * vertex_slice.n_atoms) +  # dead states copy
                (4 * vertex_slice.n_atoms) +  # coord x state
                (4 * vertex_slice.n_atoms) +  # coord y state
                20000)  # extra buffer from other stuff
