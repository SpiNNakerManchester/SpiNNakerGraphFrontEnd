...
static void update(uint ticks, uint b) {
    ...
    if ((infinite_run != TRUE) && (time >= simulation_ticks)) {
        ...
        log_info("Float 1.0f as hex = %a", 1.0f);
        log_info("Double 1.0f as hex = %A", 1.0d);
        log_info("Char q = %c", 'q');
        ...
        log_info("Float 21213433434.342134342f ~ %f", 21213433434.342134342f);
        log_info("Float 1.0f = %f", 1.0f);
        log_info("Float 0.000000000000043343f ~ %f", 0.000000000000043343f);
        log_info("Float 0.0f = %f", 0.0f);
        log_info("Float -0.000000000000043343f ~ %f", -0.000000000000043343f);
        log_info("Float -2.0f = %f", -2.0f);
        log_info("Float -434345454545522.453534f ~ %f", -434345454545522.453534f);
        log_info("Float 1/0f = %f", 1/0.0f);
        log_info("Float 0/0f = %f", 0/0.0f);
        log_info("Float -1/0f = %f", -1/0.0f);
        log_info("Double 21213433434.342134342d ~ %F", 21213433434.342134342d);
        log_info("Double 1.0d = %F", 1.0d);
        log_info("Double 0.000000000000043343d ~ %F", 0.000000000000043343d);
        log_info("Double 0.0d = %F", 0.0d);
        log_info("Double -0.000000000000043343d ~ %F", -0.000000000000043343d);
        log_info("Double -2.0d = %F", -2.0d);
        log_info("Double -434345454545522.453534d ~ %F", -434345454545522.453534f);
        log_info("Double 1/0d = %d", 1/0.0d);
        log_info("Double 0/0d = %d", 0/0.0d);
        log_info("Double -1/0d = %d", -1/0.0d);
