...
class HelloWorldVertexWithKeyAllocation(
    ...
    def __init__(
        self, n_hellos, key, n_keys, label=None, constraints=None):
        super(HelloWorldVertexWithKeyAllocation, self).__init__(
            label, "hello_world2.aplx", constraints=constraints)
    ...
    def get_outgoing_partition_constraints(self, partition):
        return [FixedKeyAndMaskConstraint(
            [BaseKeyAndMask(self._key, 0xFFFFFFFE)])]
