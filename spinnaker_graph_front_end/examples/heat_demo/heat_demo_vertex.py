...
class HeatDemoVertex(
    ...
    def __init__(self, label, machine_time_step, time_scale_factor,
        ...
        resources = ResourceContainer(cpu=CPUCyclesResource(45),
    ...
    def generate_data_spec(
        ...
        :param sub_graph: the graph object for this dsg
    ...
    def _write_transmission_keys(self, spec, routing_info, subgraph):
        ...
        partitions = subgraph.get_outgoing_edge_partitions_starting_at_vertex(
            self)
    ...
    def _write_key_data(self, spec, routing_info, sub_graph):
        ...
        # get incoming edges
        incoming_edges = sub_graph.get_edges_ending_at_vertex(self)
        ...
        out_going_edges = sub_graph.get_edges_starting_at_vertex(self)
        ...
        direction_edges = {
            subedge.direction.value: subedge for subedge in direction_edges
        }
        ...
        fake_temp_edges = {
            subedge.direction.value: subedge for subedge in fake_temp_edges
        }
        current_direction = 0
        for current_direction in range(4):
